...
ui <- fluidPage(
  wellPanel(radioButtons(inputId="type_of_countries", "Browse all countries or select a country group", choiceNames = list('All countries',div(HTML("<em>Prospects</em> countries")),  div(HTML("<em>Blueprint</em> countries")),div(HTML("<em>No Lost Generation</em>"))),
                         choiceValues = c('world','prospects','blueprint','lostgen'), selected = 'prospects',inline = T),
  ...
  conditionalPanel(
    condition = "input.type_of_countries == 'world'",
    wellPanel(tags$head(tags$style('.selectize-dropdown {z-index: 100000000 !important;}')),
              ...
              selectInput(
                inputId = "world_country", label = NULL,
                choices = choices,
                selected = choices[1],
                multiple = F,
                width = '400px'
  ...
  conditionalPanel(
    condition = "input.type_of_countries == 'prospects'",
    wellPanel(tags$hr(),
  ...
  conditionalPanel(
    condition = "input.type_of_countries == 'blueprint'",
    wellPanel(tags$hr(),
  ...
  conditionalPanel(
    condition = "input.type_of_countries == 'lostgen'",
    wellPanel(tags$hr(),
